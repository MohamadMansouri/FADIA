...
#ifdef RUNTIME_TEST
#ifdef WIRELESS
#error "Runtime test should be performed in the wired setting"
#endif
#endif
...
#ifdef ENERGY_TEST
#ifndef WIRELESS
#error "Energy test should be performed in the wireless setting"
#endif
#endif

#ifndef ENERGY_TEST
#ifndef RUNTIME_TEST
#error "Either Runtime test or Energy test should be specified"add_const
#endif
#endif
